...
function summary() {
    ...
    if (html($(`.${$current_player} h1`)) > 149) {
        ...
        $finalMSG = `${$d1}<br>${$d2}<br><img src="files/images/goldcup.png" width="100px" height="100px"> <br> <h1>${html($(`.${$current_player} h2`))} wins!</h1> <br> <button onclick="window.location.replace('index.html')">Restart</button><br><br> <a href="https://buymeacoffee.com/ronaldoexcel" title="Support Me">Donate to help me make more.</a><br>`;
